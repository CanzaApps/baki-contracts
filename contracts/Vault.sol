...
contract Vault is Ownable {
  ...
  */
    ...
    uint private zCFAzUSDPair = 621;
    uint private zNGNzUSDPair = 415;
    uint private zZARzUSDPair = 16;
    ...
    */ 
    ...
    uint private collaterizationRatioValue = 1500;
    ...
    */
     ...
     */
    function deposit(uint256 _depositAmount, uint256 _mintAmount) public payable returns(string memory) {
        ...
        */
        User[msg.sender].userDebtOutstanding = netMintUser[msg.sender][zUSD]/netMintGlobal[zUSD] * (IERC20(zUSD).totalSupply() + 
        ...
        */
        User[msg.sender].collaterizationRatio = User[msg.sender].userCollateralBalance/User[msg.sender].userDebtOutstanding * 1000;
    ...
    */
    function repayAndWithdraw(uint256 _amountToRepay, uint256 _amountToWithdraw, address _zToken, uint exchangeRate) public payable returns(string memory) {
      ...
      */
      netMintUser[msg.sender][zUSD] -= (amountToRepayinUSD/User[msg.sender].userDebtOutstanding) * netMintUser[msg.sender][zUSD];
